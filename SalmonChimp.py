...
tempListIn = ['OMAW','xxxxx', 'CDAW1', 'ANEW1', 'FBFW1','KOMK', 'SAMW1', 'xxxxx']
precipListIn=['xxxxx','xxxxx', 'CDAW1', 'ANEW1', 'FBFW1','KOMK']
snowListIn=['728:WA:SNTL', '1259:WA:SNTL']
runoffListIn=['12446150', '12446400']
key='e8c949a5d4044602ac8bafd58ef4dbb4'
